                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#">
                                                <img alt="image" src="{{url('otika')}}/assets/img/users/user-1.png" class="rounded-circle" width="35" data-toggle="title" title="">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#">
                                                <img alt="image" src="{{url('otika')}}/assets/img/users/user-2.png" class="rounded-circle" width="35" data-toggle="title" title="">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#">
                                                <img alt="image" src="{{url('otika')}}/assets/img/users/user-3.png" class="rounded-circle" width="35" data-toggle="title" title="">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#">
                                                <img alt="image" src="{{url('otika')}}/assets/img/users/user-4.png" class="rounded-circle" width="35" data-toggle="title" title="">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#">
                                                <img alt="image" src="{{url('otika')}}/assets/img/users/user-5.png" class="rounded-circle" width="35" data-toggle="title" title="">
                                                <span class="d-inline-block ml-1">Hasan Basri</span>
                                            </a>
                                        </td>
                                        <td>Post Title 5
