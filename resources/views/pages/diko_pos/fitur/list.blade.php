                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($posts as $post)
                                                <tr>
                                                    <td>{{ $no++ }}</td>
                                                    <td>{{ $post->icon1 }}</td>
                                                    <td>{{ $post->judul_icon1 }}</td>
                                                    <td>{{ $post->judul_detail }}</td>
                                                    <td>{{ $post->isi_detail }}</td>
                                                    <td>
                                                        <div class="d-flex justify-content">
                                                            <a href="{{ route('pos.fitur.preview', ['id' => $post->id]) }}" class="btn btn-primary">Preview</a>
                                                            ...
                                                            <form id="delete-form-{{ $post->id }}"
                                                                action="{{ route('pos.fitur.destroy', ['id' => $post->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
