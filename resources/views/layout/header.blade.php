                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
                          ...
                          text-white"> <img
                                            alt="image" src="{{ url('otika') }}/assets/img/users/user-1.png"
                                        ...
                                        <img alt="image" src="{{ url('otika') }}/assets/img/users/user-2.png"
                                            class="rounded-circle">
                                        ...
                                        class="dropdown-item-avatar text-white">
                                        <img alt="image" src="{{ url('otika') }}/assets/img/users/user-5.png"
                                            class="rounded-circle">
                                        ...
                                        class="dropdown-item-avatar text-white">
                                        <img alt="image" src="{{ url('otika') }}/assets/img/users/user-4.png"
                                            class="rounded-circle">
                                        ...
                                        class="dropdown-item-avatar text-white">
                                        <img alt="image" src="{{ url('otika') }}/assets/img/users/user-3.png"
                                            class="rounded-circle">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image"
                                src="{{ url('otika') }}/assets/img/user.png" class="user-img-radious-style"> <span
