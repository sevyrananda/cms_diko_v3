            ...
            <div class="card card-primary mx-auto">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <form action="{{ route('register') }}" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input id="name" type="text" class="form-control" name="name" placeholder="Masukkan Nama" autofocus>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input id="email" type="email" class="form-control" name="email" placeholder="Masukkan Email">
                  ...
                  <div class="col-md-6">
                    <!-- Gambar Anda -->
                    <img src="{{url('otika')}}/assets/img/diko.png" alt="Your Image" class="img-fluid">
                  </div>
                </div>
              </div>
